    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if (mChart.getViewPortHandler().getScaleX() > mChart.getViewPortHandler().getMinScaleX()
                        || mChart.getViewPortHandler().getScaleY() > mChart.getViewPortHandler().getMinScaleY()) {//如果有可以的拖动的内容，禁止滑动
