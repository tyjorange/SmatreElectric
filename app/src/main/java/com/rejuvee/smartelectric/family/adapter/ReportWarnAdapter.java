...
public class ReportWarnAdapter extends RecyclerView.Adapter<BindingViewHolder> {
    private static final int VIEW_TYPE_EMPTY = 0;
    private static final int VIEW_TYPE_ITEM = 1;
    private final LayoutInflater mLayoutInflater;
    private List<ReportDetailBean.Warn> mListData;

    public ReportWarnAdapter(Context context) {
...
//    }
    ...
    public BindingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_EMPTY) {
            ...
            binding = DataBindingUtil.inflate(mLayoutInflater, R.layout.item_report_warn, parent, false);
        }
    ...
    public void onBindViewHolder(@NonNull BindingViewHolder holder, int position) {
        if (mListData.size() != 0) {
            final ReportDetailBean.Warn bean = mListData.get(position);
            ...
            //
            TextView textView2 = holder.itemView.findViewById(R.id.tv_warn_type);
            textView2.setText(SwitchBean.getSwitchFaultState(context, bean.getErrType()));
            //
            TextView textView3 = holder.itemView.findViewById(R.id.tv_warn_count);
...
//    }
     ...
     * @param list
     */
    public void addAll(List<ReportDetailBean.Warn> list) {
        mListData.clear();
