...
public class ReportPowerAdapter extends RecyclerView.Adapter<BindingViewHolder> {
    private static final int VIEW_TYPE_EMPTY = 0;
    private static final int VIEW_TYPE_ITEM = 1;
    private final LayoutInflater mLayoutInflater;
    private List<ReportDetailBean.Power> mListData;

    public ReportPowerAdapter(Context context) {
...
//    }
    ...
    public BindingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_EMPTY) {
            ...
            binding = DataBindingUtil.inflate(mLayoutInflater, R.layout.item_report_power, parent, false);
        }
    ...
    public void onBindViewHolder(@NonNull BindingViewHolder holder, int position) {
        if (mListData.size() != 0) {
            final ReportDetailBean.Power bean = mListData.get(position);
...
//            textView2.setText(SwitchBean.getSwitchFaultState(context, bean.getErrType()));
            //
            TextView textView3 = holder.itemView.findViewById(R.id.tv_power_count);
            textView3.setText(String.format(Locale.getDefault(), "%.2f%s", bean.getCount(), context.getString(R.string.vs18)));
            //
...
//            holder.tv_power_count = convertView.findViewById(R.id.tv_power_count);
...
//    }
     ...
     * @param list
     */
    public void addAll(List<ReportDetailBean.Power> list) {
        mListData.clear();
