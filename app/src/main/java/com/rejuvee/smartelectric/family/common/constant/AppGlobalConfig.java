...
public class AppGlobalConfig {
    public static String BASIC_CONFIG = "basic_config";
    ...
    //    public static String HTTP_ECHARTES_TEMPLATE_URL = "http://192.168.1.162:8088/";// 测试echarts
    public static String HTTP_ECHARTES_TEMPLATE_URL = "https://rejuvee.net/";
}
