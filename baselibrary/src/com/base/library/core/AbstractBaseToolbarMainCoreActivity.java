 ...
 */
public abstract class AbstractBaseToolbarMainCoreActivity extends AbstractBaseCoreActivity {
    private static final String LOGTAG = LogUtil.makeLogTag(AbstractBaseToolbarMainCoreActivity.class);
